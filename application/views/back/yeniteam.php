        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <!--end::Card header-->
                    <!--begin::Form-->
                    <form id="kt_project_settings_form" class="form" action="<?php echo base_url('admin/yeniteamup'); ?>" method="post" enctype="multipart/form-data">
                        <!--begin::Card body-->
                        <?php echo flashread(); ?>
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-xl-12 fv-row">
                                        <input type="text" class="form-control form-control-solid" required name="trstatu" value="" />
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="col-xl-12">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-xl-12 fv-row">
                                        <input type="text" class="form-control form-control-solid" required name="enstatu" value="" />
                                    </div>
                            ...
                            <div class="mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-12 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="kurum" value="" />
                                </div>
                            </div>
                            <!--end::Row-->
