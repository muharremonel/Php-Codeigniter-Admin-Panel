        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Haberler Düzenleme Seçenekleri</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Haberler / Genel Düzenleme</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Add customer-->
                            <a href="<?php echo base_url('admin/yenihaber') ?>" class="btn btn-danger">Yeni Haber</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Card toolbar-->
                        <!--end::Card title-->
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_category_table">
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-250px sorting" tabindex="0" aria-controls="kt_ecommerce_category_table" rowspan="1" colspan="1" aria-label="Category: activate to sort column ascending" style="width: 690.406px;">Haber</th>
                                            ...
                                            <tbody id="sortable" class="fw-semibold text-gray-600">
                                                <?php foreach ($haber as $haber) { ?>
                                                    <!--begin::Table row-->
                                                    <!--end::Table row-->
                                                    <tr id="listItem_<?php echo $haber['h_id']; ?>">
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <a href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-category.html" class="symbol symbol-50px">
                                                                    <span class="symbol-label" style="background-image:url(<?php echo base_url($haber['gorsel1']); ?>)"></span>
                                                                </a>
                                                                <!--end::Thumbnail-->
                                                                <div class="ms-5">
                                                                    <!--begin::Title-->
                                                                    <span class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name"><?php echo $haber['tr_anabaslik']; ?></span>
                                                                    <!--end::Title-->
                                                                    <!--begin::Description-->
                                                                    <!--end::Description-->
                                                                </div>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="col-md-8 px-2 py-3">
                                                                <select onchange="window.location.href=`<?php echo base_url('admin/haber_update/') . $haber['h_id'] . '/'; ?>${this.value}`" name="active" class="form-select form-select-solid active-haber " data-control="select2" data-placeholder="Select an option">
                                                                    <option <?php echo ($haber['active'] == 1) ? 'selected' : ''; ?> value="1">Aktif</option>
                                                                    <option <?php echo ($haber['active'] == 2) ? 'selected' : ''; ?> value="2">Pasif</option>
                                                                </select>
                                                            </div>
                                                            <!--end::Badges-->
                                                        </td>
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="<?php echo base_url('admin/delete_haber/' . $haber['h_id']); ?>" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_heyet">Haber Sil</a>
                                                                    <a href="<?php echo base_url('admin/haberduzenle/' . $haber['h_id']); ?>" class="menu-link px-3">Düzenle</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                            </div>
                                                            <!--end::Menu-->
                                                    ...
                                                    <input class="hid" type="hidden" name="hid" value="<?php echo $haber['h_id']; ?>">
                                                <?php } ?>
                                            </tbody>
                                            <!--end::Table body-->
                                        </table>
    ...
    $(document).ready(function() {
        $("#sortable").sortable({
            ...
            update: function() {
                ...
                window.location.href = "<?php echo base_url('admin/haber_update_order?'); ?>" + order;
            }
        });
    });
</script>