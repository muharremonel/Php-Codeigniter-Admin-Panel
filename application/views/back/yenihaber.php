        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Yeni Haber Ekleme Seçenekleri</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <!--end::Card header-->
                    <!--begin::Form-->
                    <form id="kt_project_settings_form" class="form" action="<?php echo base_url('admin/yenihaberup'); ?>" method="post" enctype="multipart/form-data">
                        <!--begin::Card body-->
                        <div class="tab-content">
                            <div class="card-body p-9 tab-pane fade show active" id="kt_builder_main" role="tabpanel1">
                                ...
                                <div class="mt-5 mb-8">
                                    ...
                                    <div class="col-xl-12 fv-row">
                                        <input type="text" class="form-control form-control-solid" name="tr_anabaslik" value="" />
                                    </div>
                                </div>
                                <!--end::Row-->
                                <!--begin::Row-->
                                <div class="mt-5 mb-8">
                                    ...
                                    <div class="col-xl-3">
                                        ...
                                        <div class="form-text mb-2">Bu kısıma haberin sahibini veya ufak başlığını giriniz.</div>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-xl-12 fv-row">
                                        <input type="text" class="form-control form-control-solid" name="tr_name" value="" />
                                    </div>
                                </div>
                                <!--end::Row-->
                                <div class="row mb-5">
                                    <div class="col-md-6 mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="image-input image-input-outline mb-5" data-kt-image-input="true" style="background-image: url('<?php echo base_url('assets/back/demo1/dist/'); ?>assets/media/team/no-avatar.png')">
                                                <!--begin::Preview existing avatar-->
                                                <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image: url('<?php echo base_url('assets/back/demo1/dist/'); ?>assets/media/team/no-avatar.png')"></div>
                                                ...
                                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Görsel Seç">
                                                    ...
                                                    <input type="hidden" name="gorsel1" />
                                                    <!--end::Inputs-->
                                                </label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="tr_summary" cols="70" rows="10"></textarea>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <textarea name="tr_content" id="editor"></textarea>
                                </div>
                                ...
                                <div class="mt-5 mb-8">
                                    ...
                                    <div class="col-xl-5">
                                        ...
                                        <div class="form-text mb-2">Bu kısma haber tarihini giriniz.</div>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-xl-12 fv-row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="image-input image-input-outline mb-5" data-kt-image-input="true" style="background-image: url('<?php echo base_url('assets/back/demo1/dist/'); ?>assets/media/team/no-avatar.png')">
                                                ...
                                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Görsel Seç">
                                                    ...
                                                    <input type="hidden" name="gorsel2" />
                                                    <!--end::Inputs-->
                                                </label>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="image-input image-input-outline mb-5" data-kt-image-input="true" style="background-image: url('<?php echo base_url('assets/back/demo1/dist/'); ?>assets/media/team/no-avatar.png')">
                                                ...
                                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Görsel Seç">
                                                    ...
                                                    <input type="hidden" name="gorsel3" />
                                                    <!--end::Inputs-->
                                                </label>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="image-input image-input-outline mb-5" data-kt-image-input="true" style="background-image: url('<?php echo base_url('assets/back/demo1/dist/'); ?>assets/media/team/no-avatar.png')">
                                                ...
                                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Görsel Seç">
                                                    ...
                                                    <input type="hidden" name="gorsel4" />
                                                    <!--end::Inputs-->
                                                </label>
                            ...
                            <div class="card-body p-9 tab-pane fade" id="kt_builder_layout" role="tabpanel2">
                                ...
                                <div class="mt-5 mb-8">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-xl-12 fv-row">
                                        <input type="text" class="form-control form-control-solid" name="en_anabaslik" value="" />
                                    </div>
                                </div>
                                <!--end::Row-->
                                <!--begin::Row-->
                                <div class="mt-5 mb-8">
                                    ...
                                    <div class="col-xl-5">
                                        <div class="fs-6 fw-semibold mt-2 mb-3">Haber Adı</div>
                                        <div class="form-text mb-2">Bu kısma haber adını veya haber sahibini giriniz.</div>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-xl-12 fv-row">
                                ...
                                <div>
                                    <div class="form-text mb-2">Bu Kısımda yukarıda yüklenilen görselin altına gövde metini açıklamayı yazınız.
                                        Kutunun üst kısmında bulunan seçeneklere göre yazınızı düzenleyiniz. "Lütfen bu kısımda görsel eklemeyiniz!"</div>
                                    <textarea name="en_content" id="editoren"></textarea>
                                </div>
