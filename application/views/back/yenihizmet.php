        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Yeni Hizmet Ekleme Seçenekleri</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <!--end::Card header-->
                    <!--begin::Form-->
                    <form id="kt_project_settings_form" class="form" action="<?php echo base_url('admin/yenihizmetup'); ?>" method="post" enctype="multipart/form-data">
                        <!--begin::Card body-->
                        <div class="tab-content">
                            <div class="card-body p-9 tab-pane fade show active" id="kt_builder_main" role="tabpanel1">
                                ...
                                <div class="mt-5 mb-8">
                                    ...
                                    <div class="col-xl-12 fv-row">
                                        <input type="text" class="form-control form-control-solid" name="tr_baslik" value="" />
                                    </div>
                                </div>
                                <!--end::Row-->
                                <!--begin::Row-->
                            ...
                            <div class="card-body p-9 tab-pane fade" id="kt_builder_layout" role="tabpanel2">
                                ...
                                <div class="mt-5 mb-8">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-xl-12 fv-row">
                                        <input type="text" class="form-control form-control-solid" name="en_baslik" value="" />
                                    </div>
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="col-md-6">
                                    <div class="form-text mb-2">Hizmeti kısaca özet şeklinde yazınız.</div>
                                    <textarea name="en_summary" cols="70" rows="10"></textarea>
                                </div>
