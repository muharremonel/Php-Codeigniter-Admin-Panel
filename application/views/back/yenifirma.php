        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Yeni Firma Ekleme İşlemleri</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <!--end::Card header-->
                    <!--begin::Form-->
                    <form id="kt_project_settings_form" class="form" action="<?php echo base_url('admin/yenifirmaup'); ?>" method="post" enctype="multipart/form-data">
                        <!--begin::Card body-->
                        <?php echo flashread(); ?>
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-lg-8">
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('<?php echo base_url('assets/back/demo1/dist/'); ?>assets/media/team/no-avatar.png')">
                                        ...
                                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Görsel Seç">
                                            ...
                                            <!--begin::Inputs-->
                                            <input type="file" name="gorsel" accept=".png, .jpg, .jpeg .svg" />
                            ...
                            <div class=" mb-8">
                                <!--begin::Col-->
                                <div class="col-xl-3">
                                    <div class="fs-6 fw-semibold mt-2 mb-3">Firma Adı</div>
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                            ...
                            <div class="mb-8">
                                <!--begin::Col-->
                                <div class="col-xl-3">
                                    <div class="fs-6 fw-semibold mt-2 mb-3">Firma Linki</div>
                                    <div class="form-text mb-3">Firmanın aktif web sitesi veya konumunu giriniz.</div>
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-xl-12 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="link" value="" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-12 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="mail" value="" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-12 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="faks" value="" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-12 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="tel" value="" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-12 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="web" value="" />
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-12 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="adres" value="" />
                                </div>
                            </div>
                            <!--end::Row-->
                            ...
                            <div class="mb-8">
                                ...
                                <!--begin::Col-->
                                <div class="col-xl-12 fv-row">
                                    <input type="text" class="form-control form-control-solid" name="lokasyon" value="" />
                                </div>
                            </div>
                            <!--end::Row-->
