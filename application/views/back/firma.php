                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Add customer-->
                            <a href="<?php echo base_url('admin/yenifirma') ?>" class="btn btn-primary">Yeni Firma</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Card toolbar-->
                        <!--end::Card title-->
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_category_table">
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-250px sorting" tabindex="0" aria-controls="kt_ecommerce_category_table" rowspan="1" colspan="1" aria-label="Category: activate to sort column ascending" style="width: 690.406px;">Firmalar</th>
                                            ...
                                            <tbody id="sortable" class="fw-semibold text-gray-600">
                                                <?php foreach ($firma as $firma) { ?>
                                                    <!--begin::Table row-->
                                                    <!--end::Table row-->
                                                    <tr id="listItem_<?php echo $firma['f_id']; ?>">
                                                        <!--begin::Checkbox-->
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <a href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-category.html" class="symbol symbol-50px">
                                                                    <span class="symbol-label" style="background-image:url(<?php echo base_url($firma['gorsel']); ?>)"></span>
                                                                </a>
                                                                <!--end::Thumbnail-->
                                                                <div class="ms-5">
                                                                    <!--begin::Title-->
                                                                    <span class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name"><?php echo $firma['name']; ?></span>
                                                                    <!--end::Title-->
                                                                    <!--begin::Description-->
                                                                    <!--end::Description-->
                                                                </div>
                                                        ...
                                                        <!--begin::Type=-->
                                                        <td>
                                                            <select onchange="window.location.href=`<?php echo base_url('admin/firma_update/') . $firma['f_id'] . '/'; ?>${this.value}`" name="active" class="form-select form-select-solid active-firma " data-control="select2" data-placeholder="Select an option">
                                                                <option <?php echo ($firma['active'] == 1) ? 'selected' : ''; ?> value="1">Aktif</option>
                                                                <option <?php echo ($firma['active'] == 2) ? 'selected' : ''; ?> value="2">Pasif</option>
                                                            </select>
                                                        </td>
                                                        <!--end::Type=-->
                                                        <!--begin::Action=-->
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="<?php echo base_url('admin/delete_firma/' . $firma['f_id']); ?>" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_heyet">Firma Sil</a>
                                                                    <a href="<?php echo base_url('admin/firmaduzenle/' . $firma['f_id']); ?>" class="menu-link px-3">Düzenle</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                            </div>
                                                            <!--end::Menu-->
                                                    ...
                                                    <input class="fid" type="hidden" name="fid" value="<?php echo $firma['f_id']; ?>">
                                                <?php } ?>
                                            </tbody>
                                            <!--end::Table body-->
                                        </table>
    ...
    $(document).ready(function() {
        $("#sortable").sortable({
            ...
            update: function() {
                ...
                window.location.href = "<?php echo base_url('admin/firma_update_order?'); ?>" + order;
            }
        });
    });
</script>